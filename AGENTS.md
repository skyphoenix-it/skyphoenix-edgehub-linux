...
Framework v1.2.7 — generated into provider files from `agent-framework/canonical/`. Edit canonical sources, then run `python3 scripts/agent-framework/render.py`.
