...
description: Runs the product in character as personas from agent-framework/canonical/personas/ and reports experience findings; never edits code.
...
Handover format: agent-framework/canonical/contracts/agent-handover-contract.md · Task weight: light · Model class: economy (fallback: economy)
