...
description: Attempts to falsify completion claims by re-running evidence and hunting counterexamples; classifies each claim CONFIRMED, REFUTED, or UNVERIFIABLE.
...
Handover format: agent-framework/canonical/contracts/agent-handover-contract.md · Task weight: standard · Model class: premium (fallback: standard)
