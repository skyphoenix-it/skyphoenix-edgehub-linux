...
<!-- GENERATED from agent-framework/canonical/skills/debug-systematically/SKILL.md — edit the canonical source, then run: python3 scripts/agent-framework/render.py -->
